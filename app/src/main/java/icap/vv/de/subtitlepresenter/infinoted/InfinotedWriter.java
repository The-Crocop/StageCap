...
import icap.vv.de.subtitlepresenter.XmlPullConnection;
 ...
 *
 */
public class InfinotedWriter implements Serializable{

	private final static String TAG = "InfinotedWriter";
	...
	public InfinotedWriter() {
		...
		client.setClientHandler(new InfinotedClientHandler() {
			...
			public void onConnect() {
                ...
                buffer = new BufferSimple();
				client.createSession(InfinotedWriter.this.path, buffer, new SessionEventCallback() {
